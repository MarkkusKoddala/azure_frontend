...
async function listiraamatud() {
    ...
    for (let raamat of responseData) {
        ...
        resultElement.innerHTML += `<a href="http://localhost:5000/raamatud/${raamatNimi}" download="${raamatNimi}">${raamat}</a> <a href="#" onclick="deleteObject('http://localhost:5000/raamatud/${raamatNimi}')">[kustuta]</a><br />`;
    }
}
